...
export class ViewRestaurant {
  static readonly type = '[order-meal.component] ViewRestaurant';
  constructor(public payload: Restaurant) { }
}
export class AddItemToBag {
  static readonly type = '[view-menu.component] AddItemToBag';
  constructor(public payload: ItemOnBag, public restaurantId: string) { }
}
...
export class EmptyBag {
  static readonly type = '[app] EmptyBag';
  constructor(public newSelectedRestaurant: string) { }
}
